  ...
  return (
    <div className="lg:w-[1170px] mx-auto mt-[100px]">
      <footer className="bg-gray-700 text-white">
        <div
          className="container p-4 py-6 flex justify-between items-center"
          bis_skin_checked="1"
        >
          <div>
          <h3 className="text-2xl font-semibold">Sheik Jayed Uddin</h3>
          ...
          >
            <div className="flex justify-center space-x-4" bis_skin_checked="1">
              <a
                ...
                href="https://www.instagram.com/jayed__xishan/"
                title="Instagram"
              ...
              <a
                rel="noopener noreferrer"
                href="https://www.facebook.com/skjayed.uddinjishan/"
                title="Facebook"
                className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-600 dark:text-gray-50"
              >
                <svg
